...
## 251018-Global-Installation

> lets do option 2 — then any change we make i nthe porject we can just glovbal update and itworks evrywhere?

## 251018-Minimal-Context-Structure

> ├── conversations/          # Session bookmarks (empty - unused currently)
  ├── dashboard/              # Timeline, sunrise (empty initially)<< we dont need either of these yet. ///  ├── architecture/     # Architecture docs
      ├── business-logic/   # Business logic docs
      └── schemas/          # Schema docs <<< lets leave document folder empty for now. // changes and modules fodlers have .changes .modules

## 251018-Runbook-Pattern

> i think we need a /salsh command for each of them that has their runbook. so ican /imem find this or that. and that agent is now blessed with the full knowelge of imem and my $AREUGENTS. i think thats tyhe quickest way to move forwad.

## 251018-No-Agents-Just-Runbooks

> i dont think we need the agents. we are giving YOU or any other CLAUDE CODE the runbook for trace VIA slash command. basically a dynaimclly injected README at point of using it rather than clogging up the claude.md with it for isntance.

## 251018-Comprehensive-Runbooks

> yes. you're going to give a bit more finromation that that for each tho?

## 251018-Slash-Commands-Location

> /home/axp/.claude/commands/aura/imem.md
/home/axp/.claude/commands/aura/orca.md
/home/axp/.claude/commands/aura/trace.md i moved them
